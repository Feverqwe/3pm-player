...
java -jar compiler.jar --js ./scripts/engine/notification.js --js_output_file ./build/scripts/engine/notification.js
...
#make engine/tags.js
java -jar compiler.jar --js ./scripts/engine/tags.js --js_output_file ./build/scripts/engine/tags.js
