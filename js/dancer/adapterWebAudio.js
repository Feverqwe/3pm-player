(function() {
  ...
  var adapter = function ( dancer ) {
      ...
      this.context = this._viz.getAdapter().context;
  };
...
*/
  ...
  function connectContext () {
      var ad = this._viz.getAdapter();
      this.audio = ad.audio;
      this.source = ad.source;
      if (ad.proc_list[this.type] !== undefined) {
          ad.proc_list[this.type].disconnect();
          console.log('del old proc!');
          delete ad.proc_list[this.type];
      }
      this.proc._window = window.window;
      this.ad = ad;
      ad.proc_list[this.type] = this.proc;
